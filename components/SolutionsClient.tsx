  ...
  const industries = [
    {
      ...
      description:
        "Build intelligent financial systems with AI-powered fraud detection, algorithmic trading, and risk assessment.",
      features: [
        "Fraud Detection",
        "Algorithmic Trading",
        "Risk Assessment",
    ...
    },
    {
      ...
      description:
        "HIPAA-compliant AI solutions for patient data analysis, diagnostic assistance, and treatment optimization.",
      features: [
        "Patient Data AI",
    ...
    },
    {
      ...
      description:
        "Transform customer experience with personalization engines, inventory prediction, and dynamic pricing.",
      features: [
        "Personalization",
    ...
    },
    {
      ...
      description:
        "Optimize operations with predictive maintenance, quality control, and supply chain intelligence.",
      features: [
      ...
      <section className="relative pt-32 pb-20 px-4 sm:px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          <div className="text-center">
            ...
            >
              We build specialized AI solutions tailored to your industry's
              unique challenges. From FinTech to Healthcare, our expertise
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Deep domain knowledge across critical industries, delivering
      ...
      <section className="py-20 px-4 sm:px-6 bg-gradient-to-b from-gray-900 to-black">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Built on cutting-edge technologies, our solutions are scalable,
